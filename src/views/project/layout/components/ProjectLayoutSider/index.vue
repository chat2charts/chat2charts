      ...
      <aside>
        <n-space vertical class="go-project-sider-top">
          ...
          <div class="flex-container">
            <n-icon>
              <BarChartOutlineIcon v-show="designStore.getDarkTheme"></BarChartOutlineIcon>
              <BarChartIcon v-show="!designStore.getDarkTheme"></BarChartIcon>
            </n-icon>
            <span>Chat2Charts</span>
          </div>
        </n-space>
        <n-menu
          :value="menuValue"
...
const { BarChartOutlineIcon,BarChartIcon } = icon.ionicons5
