...
export const LoginRoute: RouteRecordRaw = {
  ...
  // component: () => {
  //   window.location.href = 'http://localhost:9528/#/login'//本地
  //   // 一版
  //   // window.location.href = 'http://ip:9001/indicator/#/login'
  //   // 二版
  //   // window.location.href = 'http://120.53.247.67/indicator/#/login'
