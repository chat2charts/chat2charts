...
import { removeToken,getToken, getToken2, setToken1,setToken3, getToken3, removeToken2, removeToken3 } from './auth'
...
//     setLocalStorage('lastTime', new Date().getTime())
//   }
// }
// function checkTimeout() {
//   currentTime = new Date().getTime() // 更新当前时间
//   lastTime = getLocalStorage('lastTime')
...
export const loginCheck = () => {
  try {
    ...
    currentTime = new Date().getTime() // 更新当前时间
    lastTime = getLocalStorage('lastTime')
    // console.log(lastTime,1702284407638)//获取不到上个系统的lastTime?
    // if (currentTime - 1702284407638 > timeOut) {
    ...
    if(!getToken3() || !getToken2() || !getToken()){
      removeToken()
      removeToken2()
      removeToken3()
      // 判断是否超时
