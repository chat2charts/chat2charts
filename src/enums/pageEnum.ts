...
export enum PageEnum {
  ...
  // 工作台
  BASE_HOME_SQLSERVER = '/project/sql-workbench',
  BASE_HOME_SQLSERVER_NAME = 'Project-Sql-Workbench',

  // 新建数据源
  NEW_DATASOURCE = '/project/new-datasource',
  NEW_DATASOURCE_NAME = 'Projetc-New-Datasource',

  // 数据库树
  DATASOURCE_TREE = '/project/datasource-tree',
  DATASOURCE_TREE_NAME = 'Projetc-Datasource-Tree',
}
